...
import json
import os
from backbone_preprocess import YoloInference

# Parameter Initialization
annotation_set = "test_all"  # Choices: train, test_all
...
# yolo_inference = YoloInference(cfg_path='/opt/project/configs/yolo.cfg', weights_path='/opt/project/PreTrained/best.pt')

# for p in data_paths:
#     dataset_path = base_path + p
#     yolo_inference.init_dataset(dataset_path)
#     yolo_inference.detect('/opt/project/' + annotation_set + '_tmp.txt')


# with open('/opt/project/' + annotation_set + '_tmp.txt', 'r') as file:
#     valid_images = [line.strip() for line in file]
...
for data_path, img_type in zip(data_paths, img_types):
    ...
    for img_dir in image_dirs:
        ...
        for img_name, b_k, p_k, c_k in zip(img_names, bbox_annotations, pose_annotations, camera_annotations):
            ...
            #     print(f'No detections, skipping {img_path}')
            #     continue
...
#os.remove('/opt/project/' + annotation_set + '_tmp.txt')